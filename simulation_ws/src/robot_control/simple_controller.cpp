...
int main(int argc, char **argv)
{
    ...
    ros::Publisher left_wheel_pub = nh.advertise<std_msgs::Float64>("/wheeled_biped/left_wheel_effort_controller/command", 10);
    ros::Publisher right_wheel_pub = nh.advertise<std_msgs::Float64>("/wheeled_biped/right_wheel_effort_controller/command", 10);
