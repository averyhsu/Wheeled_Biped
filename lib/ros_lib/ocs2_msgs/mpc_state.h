#ifndef _ROS_ocs2_msgs_mpc_state_h
#define _ROS_ocs2_msgs_mpc_state_h
...
namespace ocs2_msgs
{
  ...
  class mpc_state : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "ocs2_msgs/mpc_state"; };
    virtual const char * getMD5() override { return "1becc0cb8362a822e3753aa6cf42cf70"; };
