#ifndef _ROS_ocs2_msgs_mpc_input_h
#define _ROS_ocs2_msgs_mpc_input_h
...
namespace ocs2_msgs
{
  ...
  class mpc_input : public ros::Msg
  {
    public:
    ...
    virtual const char * getType() override { return "ocs2_msgs/mpc_input"; };
